'use client';
// src/app/(app)/dashboard-old/page.tsx — Sauvegarde de l'ancien tableau de bord
// (avant remplacement par le Dashboard Directeur V2). Contenu identique à
// l'ancien src/app/(app)/dashboard/page.tsx, conservé tel quel pour référence
// et rollback éventuel. Non lié depuis la Sidebar.
